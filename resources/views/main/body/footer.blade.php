            ...
            <div class="row">
                <div class="col-md-3 col-sm-4">
                    <div class="foot-logo">
                        ...
                        <img src="{{asset('frontend/assets/img/A_footer.png')}}" style="height: 60px ;border-radius: 50%" />
...
<!-- middle-footer-start -->
<section class="middle-footer" style="background-color: #692424">
    <div class="container-fluid">
        <div class="row">
...
<!-- bottom-footer-start -->
<section class="bottom-footer" style="background-color: black">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="copyright">
                    All rights reserved © 2020 Ahmad Ali
                </div>
            </div>
            <div class="col-md-6 col-sm-6">
