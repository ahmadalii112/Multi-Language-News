        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="template-demo">
                    <a href="{{route('categories.create')}}"><button type="button" class="btn btn-success btn-fw mb-2" style="float: right">Add Category</button></a>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td> {{$row->category_urdu}}  </td>
                            <td>
                                <form method="POST" action="{{route('categories.destroy',$row->id)}}">
                                <a href="{{route('categories.edit',$row->id)}}" class="btn btn-info">Edit</a>
                                    @method('DELETE') @csrf
